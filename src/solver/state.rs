//! State vector abstractions for systems of equations.
//!
...
/// Solution storage for systems of N conservation laws.
///
...
impl SWESolution {
    ...
    pub fn get_state(&self, k: usize, i: usize) -> SWEState {
        let arr = self.get(k, i);
        SWEState::from_array(arr)
    }

    /// Set SWE state at node i in element k.
    pub fn set_state(&mut self, k: usize, i: usize, state: SWEState) {
...
mod tests {
    ...
    fn test_system_solution_element_var() {
        ...
        // Set some values
        for i in 0..n_nodes {
            sol.set(0, i, [i as f64, (i + 10) as f64]);
        }
